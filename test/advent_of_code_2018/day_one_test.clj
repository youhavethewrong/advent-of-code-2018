...
(deftest second-problem
  (testing "scenario one"
    (is (= 0 (tweak-frequency-detecting-cycles (cycle [1 -1])))))
  (testing "scenario two"
    (is (= 10 (tweak-frequency-detecting-cycles (cycle [3 3 4 -2 -4])))))
  (testing "scenario three"
    (is (= 5 (tweak-frequency-detecting-cycles (cycle [-6 3 8 5 -6])))))
  (testing "scenario four"
    (is (= 14 (tweak-frequency-detecting-cycles (cycle [7 7 -2 -7 -4])))))
  (testing "puzzle test"
    (is (= 448 (tweak-frequency-detecting-cycles (cycle puzzle-input))))))
